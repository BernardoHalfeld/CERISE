...
# A importação do tqdm é mantida caso o script seja usado de outra forma,
# mas não é mais essencial para a GUI.
try:
...
def remove_statistical_outlier_variable_v2(pcd, df,
                                           ...
                                           progress_callback=None): # PARÂMETRO DE CALLBACK ADICIONADO
    ...
    # LOOP MODIFICADO PARA USAR O CALLBACK EM VEZ DO TQDM
...
# ==============================================================================
# ORQUESTRADOR DO PROCESSO (MODIFICADO PARA SER CHAMADO PELA GUI)
# ==============================================================================

def process_scan_pair(base_path: Path, scan_id: str, params: dict, progress_callback=None): # PARÂMETRO DE CALLBACK ADICIONADO
    print("\n" + "="*80)
    ...
    try:
        ...
        pcd_cleaned, ind = remove_statistical_outlier_variable_v2(
            ...
            progress_callback=progress_callback # REPASSANDO O CALLBACK
        )
